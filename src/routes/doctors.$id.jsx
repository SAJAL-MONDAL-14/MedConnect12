        ...
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="mt-4 flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="w-full md:w-auto md:text-right">
              <div className="text-xs text-muted-foreground">Consultation fee</div>
              <div className="text-3xl font-bold text-foreground">₹{d.fee}</div>
              <Link to="/booking" className="mt-3 inline-block w-full md:w-auto text-center px-6 py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-semibold hover:opacity-90 transition">Book appointment</Link>
            </div>
          </div>
        </div>
      </section>

      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-8 grid lg:grid-cols-[1fr_360px] gap-6">
        <div className="space-y-6">
          <div className="bg-card border border-border rounded-2xl p-6">
            <h2 className="font-semibold text-lg mb-3">About</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
