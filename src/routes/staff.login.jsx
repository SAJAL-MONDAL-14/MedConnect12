    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-sm">
          ...
          <Link to="/staff/dashboard" className="mt-5 block text-center rounded-md bg-primary text-primary-foreground py-2.5 text-sm font-semibold hover:bg-primary-dark transition">Sign in to dashboard</Link>
