...
export default function ClinicLogin() {
  useEffect(() => {
    document.title = "Clinic doctor login — MedConnect";
  }, []);
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between p-10 text-white relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-foreground">
        ...
        <div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-3 max-w-md">
            {[{ v: "320+", l: "Clinic doctors" }, { v: "12k", l: "Bookings/mo" }, { v: "4.8★", l: "Avg rating" }].map((s) => (
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-sm">
          ...
          <Link to="/clinic/dashboard" className="mt-5 block text-center rounded-md bg-primary text-primary-foreground py-2.5 text-sm font-semibold hover:bg-primary-dark transition">Sign in to clinic</Link>
