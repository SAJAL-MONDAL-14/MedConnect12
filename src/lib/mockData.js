export const hospitals = [
  {
    ...
    type: "Government",
    verified: true,
    address: "Hill Cart Road, Siliguri, WB",
    city: "Siliguri",
    distanceKm: 2.1,
    driveMin: 8,
    rating: 4.3,
    ...
    phone: "+91 353 256 5000",
    emergencyPhone: "+91 353 256 5100",
    bloodBank: true,
    pin: { x: 38, y: 42 },
  },
  {
    ...
    phone: "+91 353 251 1100",
    emergencyPhone: "+91 353 251 1199",
    bloodBank: false,
    pin: { x: 60, y: 30 },
  },
  {
    ...
    type: "Private",
    verified: true,
    address: "Sevoke More, Siliguri, WB",
    city: "Siliguri",
    distanceKm: 4.2,
    driveMin: 18,
    rating: 4.7,
    ...
    phone: "+91 353 270 8800",
    emergencyPhone: "+91 353 270 8888",
    bloodBank: true,
    pin: { x: 72, y: 58 },
  },
  {
    id: "neotia",
    name: "Neotia Getwel Hospital",
    type: "Private",
    verified: true,
    address: "Uttorayon Township, Siliguri",
    city: "Siliguri",
    distanceKm: 5.8,
    driveMin: 22,
    rating: 4.5,
    ...
    phone: "+91 353 666 8888",
    emergencyPhone: "+91 353 666 8000",
    bloodBank: true,
    pin: { x: 25, y: 70 },
  },
];
...
export const clinicDoctors = [
  {
    ...
    address: "Hill Cart Road, Near City Centre",
    city: "Siliguri",
    phone: "+91 98765 11122",
    nextSlot: "Today 5:00 PM",
    avatarColor: "primary",
    about:
      "Board-certified dermatologist specializing in cosmetic and clinical skin care with 14+ years of experience.",
  ...
  },
  {
    ...
    reviews: 312,
    fee: 700,
    clinicName: "Mother & Child Clinic",
    address: "Sevoke Road, Near Cosmos Mall",
    city: "Siliguri",
    phone: "+91 98765 22233",
    nextSlot: "Tomorrow 11:00 AM",
    avatarColor: "success",
    about:
      "Senior consultant gynecologist with expertise in high-risk pregnancy and laparoscopic surgery.",
  ...
  },
  {
    ...
    address: "Pradhan Nagar, Main Road",
    city: "Siliguri",
  ...
  },
  {
    ...
    reviews: 142,
    fee: 450,
    clinicName: "ClearSound ENT Clinic",
    address: "Sevoke More",
    city: "Siliguri",
...
export const reviews = [
  {
    ...
    date: "2 weeks ago",
    comment:
      "Doctors were attentive and the OPD was well organised. Bed availability matched what was shown on the app.",
  },
  {
    id: "r2",
    name: "Rajiv Sen",
    ...
    rating: 4,
    date: "1 month ago",
    comment: "Smooth booking. ICU staff were responsive during my father's admission.",
  },
  {
    id: "r3",
    name: "Meera Pal",
    ...
    date: "1 month ago",
    comment:
      "Clean facility, slightly long wait at registration but the cardiology team was excellent.",
  },
];
...
export const myBookings = [
  ...
  },
  {
    ...
    doctor: "Dr. Sneha Roy",
    specialty: "Pediatrician",
    hospital: "CityMed Multispeciality",
    date: "Sat, 12 Apr",
    time: "4:00 PM",
    status: "Completed",
    fee: 400,
...
export const sosContacts = [
  ...
  {
    id: 3,
    name: "Dr. Family Physician",
    relation: "Doctor",
    phone: "+91 99110 88002",
    whatsapp: false,
  },
];
