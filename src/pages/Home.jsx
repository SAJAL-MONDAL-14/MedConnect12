...
const steps = [
  {
    ...
    desc: "We find the closest hospitals using your GPS — no signup needed to browse.",
  },
  {
    n: "02",
    icon: Activity,
    title: "See live beds",
    desc: "Real-time bed counts updated by hospital staff every few minutes.",
  },
  {
    n: "03",
    icon: CheckCircle2,
    title: "Book & confirm",
    desc: "Pick a slot, pay at clinic. WhatsApp confirmation sent instantly.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.12 0.04 250) 0%, oklch(0.18 0.08 250) 40%, oklch(0.22 0.10 260) 100%)",
          minHeight: "92vh",
        }}
      >
        {/* Animated grid */}
        ...
        {/* Glow orbs */}
        <div
          className="absolute top-[-10%] right-[-5%] h-[600px] w-[600px] rounded-full opacity-20"
          style={{
            background: "radial-gradient(circle, oklch(0.65 0.18 250), transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        <div
          className="absolute bottom-[-20%] left-[-10%] h-[500px] w-[500px] rounded-full opacity-15"
          style={{
            background: "radial-gradient(circle, oklch(0.55 0.18 162), transparent 70%)",
            filter: "blur(80px)",
          }}
        />
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 pt-24 pb-20">
          <div className="grid lg:grid-cols-[1fr_420px] gap-16 items-center">
            ...
            >
              ...
              >
                See real-time bed availability across 48 hospitals. No more calling around. Book a
                doctor slot in under 60 seconds.
              </p>

              {/* Search bar */}
              <form
                onSubmit={submit}
                className="mt-8 flex items-center gap-2 p-2 rounded-2xl max-w-[580px]"
                style={{
                  background: "oklch(1 0 0 / 0.08)",
                  border: "1px solid oklch(1 0 0 / 0.15)",
              ...
              <div className="mt-10 flex items-center gap-1 flex-wrap">
                {services.map((s, i) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold text-white/80 group-hover:text-white transition">
                      {s.label}
                    </span>
            ...
            >
              ...
              >
                ...
                <div className="divide-y" style={{ borderColor: "oklch(1 0 0 / 0.06)" }}>
                  {[
                    ...
                    <div
                      key={h.name}
                      className="px-5 py-3.5 flex items-center gap-3 hover:bg-white/[0.03] transition"
                    >
                      <div
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <div className="text-right">
                          ...
                          <div
                            className={`text-sm font-bold ${h.general === 0 ? "text-red-400" : "text-white"}`}
                          >
                            {h.general}
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <div
                            className={`text-sm font-bold ${h.icu === 0 ? "text-red-400" : "text-emerald-400"}`}
                          >
                            {h.icu}
                          </div>
                        </div>
                ...
                >
                  {[
                    ...
                    >
                      ...
                      <div className="text-white/40 text-[9px] uppercase tracking-wide mt-0.5">
                        {s.label}
                      </div>
                    </div>
                  ))}
              ...
              <div
                ...
                style={{
                  background: "oklch(0.20 0.08 162 / 0.6)",
                  border: "1px solid oklch(0.55 0.18 162 / 0.3)",
                  backdropFilter: "blur(16px)",
                }}
              >
                <CheckCircle2
                  className="h-5 w-5 shrink-0"
                  style={{ color: "oklch(0.65 0.18 162)" }}
                />
                <div className="flex-1 min-w-0">
                  <div className="text-white text-xs font-semibold">Booking confirmed</div>
                  <div className="text-white/50 text-[10px]">
                    Anita Kumar · Dr. Sharma · 10:00 AM
                  </div>
                </div>
                <span className="text-[10px] font-mono" style={{ color: "oklch(0.65 0.18 162)" }}>
                  Just now
                </span>
              </div>
            </div>
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Siliguri, West Bengal · Updated in real-time
            </p>
          </div>
          <Link
            to="/search"
        ...
        >
          ...
          <div className="relative px-8 py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              <div className="relative h-16 w-16 rounded-2xl bg-white/10 flex items-center justify-center shrink-0">
                <Stethoscope className="h-8 w-8 text-white" strokeWidth={2} />
              </div>
              <div>
                <div className="text-white/60 text-xs uppercase tracking-widest font-bold mb-1">
                  Doctors & Chambers
                </div>
                <h3 className="text-2xl font-bold text-white">Own a Private Chamber?</h3>
                <p className="text-white/70 text-sm mt-1 font-medium">
                  Register your private practice today to reach nearby patients and receive bookings
                  online.
                </p>
              </div>
            </div>
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-white text-primary px-6 py-3 text-sm font-bold hover:bg-white/90 transition shadow-xl shrink-0"
            >
              <Stethoscope className="h-4 w-4" /> Register Chamber{" "}
            ...
            {steps.map((s, i) => (
              ...
              >
                ...
                <div className="h-12 w-12 rounded-xl bg-primary-soft flex items-center justify-center mb-5 mt-3 group-hover:bg-primary group-hover:text-primary-foreground transition-all">
                  <s.icon
                    className="h-6 w-6 text-primary group-hover:text-white transition-all"
                    strokeWidth={1.5}
                  />
                </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div
                      className={`h-14 w-14 rounded-2xl ${avatarBg} text-white flex items-center justify-center font-bold text-lg shadow-lg group-hover:scale-105 transition-transform`}
                    >
                      {d.initials}
                    </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.14 0.04 250) 0%, oklch(0.20 0.08 260) 100%)",
            }}
          >
            <div className="px-10 py-14 grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-white/60 mt-4 text-sm leading-relaxed">
                  We connect patients with hospitals and doctors in real-time, eliminating the chaos
                  of finding healthcare in an emergency.
                </p>
      ...
      <footer style={{ background: "oklch(0.10 0.02 250)", color: "oklch(0.75 0 0)" }}>
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-5 flex gap-2">
              {["App Store", "Google Play"].map((a) => (
                <span
                  key={a}
                  className="text-xs px-3 py-1.5 rounded-lg cursor-pointer hover:opacity-80 transition"
        ...
        <div style={{ borderTop: "1px solid oklch(1 0 0 / 0.06)" }}>
          <div
            className="max-w-[1200px] mx-auto px-6 py-4 flex justify-between text-xs"
