    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-10">
        ...
        {step === 1 ? (
          <>
            ...
            <div className="flex items-stretch rounded-md border border-border overflow-hidden focus-within:border-primary transition">
              <span className="bg-primary-soft text-primary text-sm font-mono font-semibold px-3 flex items-center">
                +91
              </span>
              <input
                type="tel"
            ...
            <p className="mt-4 text-xs text-center text-muted-foreground">
              ...
              <a className="text-primary font-semibold hover:underline cursor-pointer">Register</a>
            </p>
          ...
          <>
            <button
              onClick={() => setStep(1)}
              className="text-muted-foreground hover:text-foreground inline-flex items-center gap-1 text-sm mb-4"
            >
            ...
            <p className="text-sm text-muted-foreground mt-4 mb-5">
              Enter the 6-digit code sent to your WhatsApp and SMS
            </p>
      ...
      <div className="mt-6 text-xs text-text-muted text-center space-y-1.5">
        <div className="flex items-center justify-center gap-2 flex-wrap">
          <Link to="/private-chamber/login" className="hover:text-foreground">
            Chamber doctor
          </Link>
          <span>·</span>
          <Link to="/hospital-doctor/login" className="hover:text-foreground">
            Hospital doctor
          </Link>
          <span>·</span>
