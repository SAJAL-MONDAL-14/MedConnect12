...
export default function BookingSuccess() {
  useEffect(() => {
    document.title = "Booking confirmed — MedConnect";
  }, []);
  return (
        ...
        <div className="max-w-[900px] mx-auto px-6 py-4 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-success/80">
              ...
              <span className="font-mono font-semibold">#MED-8824</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[900px] mx-auto px-6 py-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            See you on Friday — arrive 15 minutes early.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-6">
          <div className="rounded-xl bg-card border border-border overflow-hidden shadow-card">
            <div className="bg-primary text-primary-foreground px-6 py-5">
              <div className="text-xs uppercase tracking-wider opacity-80 font-mono">
                Booking #MED-8824
              </div>
            ...
            <div className="divide-y divide-border">
              {[
                ...
                <div key={row.label} className="flex justify-between px-6 py-3.5 text-sm">
                  ...
                  <span
                    className={row.muted ? "text-muted-foreground italic" : "font-medium font-mono"}
                  >
                    {row.value}
                  </span>
                </div>
          ...
          <aside className="space-y-4">
            ...
            <Link
              to="/profile"
              className="block text-center rounded-md border border-border bg-card py-2.5 text-sm font-medium hover:border-primary hover:text-primary transition"
            >
              View all bookings
            </Link>
