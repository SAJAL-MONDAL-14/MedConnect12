    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 py-14 text-white">
          ...
          <p className="mt-3 text-white/80 max-w-xl">
            Personal care from independent specialists running their own practice. Book directly —
            no hospital queues.
          </p>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-6">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            Are you a chamber doctor? Login →
          </Link>
        </div>
        {list.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {list.map((d) => {
              ...
              return (
                <div
                  key={d.id}
                  className="group bg-card border border-border rounded-2xl p-5 hover:border-primary hover:shadow-xl hover:shadow-primary/5 transition"
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`h-14 w-14 rounded-full ${bg} text-white flex items-center justify-center text-lg font-bold shrink-0`}
                    >
                      {d.initials}
                    </div>
